...
// Served by the CRM frontend itself (crm-frontend/public/email-logo.png) —
// same asset + pattern already used by lib/emailTemplates.js. Previously
// hardcoded to a media.base44.com URL; Base44 is retired and must not be a
// live dependency for customer-facing reminder emails.
const LOGO_URL = `${CRM_PUBLIC_URL}/email-logo.png`;
const NAVY = '#0B2D5C';
const GOLD = '#C9A227';
