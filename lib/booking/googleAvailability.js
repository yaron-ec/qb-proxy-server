...
// Exclude CRM travel artifacts, CRM Phone Call events (never blocking — see
// header comment), and events explicitly marked "free" on Google.
function isExcluded(event) {
  ...
  if (ext.ec_appointment_kind === 'phone_call') return true;
