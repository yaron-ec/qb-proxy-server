  ...
  try {
    ...
    await query(
      ...
      [
        claim.lead_id,
        'note',
        'Reminder sent: ' + (claim.reminder_type || 'appointment'),
        'system',
        'manual',
        JSON.stringify({ reminder_type: claim.reminder_type, scheduled_for: claim.scheduled_for }),
      ]
    );
  } catch (actErr) {
    console.warn('[reminderEngine] Activity write failed (non-blocking):', actErr.message);
  }
