...
function crmActivityEmail({ title, leadName, leadId, repName, activityType, changes, content, timestamp, crmUrl, actorEmail }) {
  ...
  const inner = `
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:16px;">
      ...
      ${row('Action By', actorEmail ? `<a href="mailto:${esc(actorEmail)}" style="color:${NAVY};">${esc(actorEmail)}</a>` : null)}
