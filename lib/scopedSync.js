...
const base44EntityGateway = require('./base44EntityGateway');
  ...
  register: function (app, deps) {
    ...
    app.post('/sync/lead-estimates', requireProxySecret, async (req, res) => {
      ...
      try {
        ...
        let lead = null;
        try { const _r = await base44EntityGateway.callGateway('get_lead', { leadId }); lead = (_r && _r.success && _r.data && _r.data.lead) ? _r.data.lead : null; } catch (e) { lead = null; }
