  ...
  register: function (app, deps) {
    ...
    app.post('/sync/lead-estimates', requireProxySecret, async (req, res) => {
      ...
      try {
        ...
        let lead = null;
        try { const _l = await b44.filter('Lead', { id: leadId }); lead = (_l && _l[0]) || null; } catch (e) { lead = null; }
    ...
    app.post('/sync/estimate-pdf', requireProxySecret, async (req, res) => {
      ...
      try {
        ...
        let rec = null;
        if (crmEstimateId) {
          try { const _r = await b44.filter('HandoffEstimate', { id: crmEstimateId }); rec = (_r && _r[0]) || null; } catch (e) { rec = null; }
