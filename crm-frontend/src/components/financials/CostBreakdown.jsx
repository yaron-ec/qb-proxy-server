  ...
  return (
    <div className="flex items-center justify-between py-2 border-b border-slate-100 last:border-0">
      ...
      <span className="flex items-baseline gap-3">
        ...
        <span className="mono text-sm font-semibold text-slate-800 tabular-nums">{formatCurrency(committed)}</span>
      </span>
    </div>
  );
}
    ...
    <div>
      ...
      <div className="card-premium p-4">
        ...
        <div className="flex items-center justify-between pt-3 mt-1 border-t-2 border-slate-200">
          ...
          <span className="mono text-base font-bold text-slate-900 tabular-nums">{formatCurrency(fin.totalCommittedCost)}</span>
        </div>
